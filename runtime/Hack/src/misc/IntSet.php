...
interface IntSet {
  ...
  public function and(IntSet $a): IntSet;
  ...
  public function complement(IntSet $elements): IntSet;
  ...
  public function or(IntSet $a): $IntSet;
  ...
  public function subtract(IntSet $a): IntSet;
